    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (header != null && header.startsWith("Bearer ")) {
            ...
            try {
                ...
                if (url.startsWith("/api/") || url.startsWith("/department/") || url.startsWith("/designation/")
                        || url.startsWith("/employee/") || url.startsWith("/holidaymaster/")|| url.startsWith("/hrPolicy/") || url.startsWith("/request/")
                        || url.startsWith("/type/") || url.startsWith("/hrms/")) {
