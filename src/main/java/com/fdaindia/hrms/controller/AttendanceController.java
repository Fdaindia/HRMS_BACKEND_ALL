...
public class AttendanceController {
	...
	@GetMapping("/total-working-hours")
    public ResponseEntity<?> getTotalWorkingHoursForMonth(
        ...
        String totalHours = attendanceService.getTotalWorkingHoursForMonth(employee, yearMonth);
...
//	
	@CrossOrigin()
	@GetMapping("/getAll")
	public ResponseEntity<List<AttendanceResponseDTO>> getAttendanceForLast30Days() {
	    List<AttendanceResponseDTO> attendances = attendanceService.findAll();
	    return ResponseEntity.ok(attendances);
	}
